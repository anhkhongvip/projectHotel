...
@section('content')
    ...
    <div class="section padding-top-bottom z-bigger">
        <div class="section z-bigger">
            <div class="container">
                <div class="row">
                    <div class="col-12 mt-4 mb-5 mt-lg-0">
                        <div class="row" id="loadRoomSearch">
                            ...
                            <div class="col-lg-6 mt-4" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
                                <div class="room-box background-grey">
                                    ...
                                    <img src="{{asset($roomType->image)}}" style="height: 350px" alt="">   {{-- img/room5.jpg--}}
                                    <div class="room-box-in">
                                        <p class="mt-3">{!! $roomType->excerpt !!}</p>
                                        <a class="mt-1 btn btn-primary" href="{{route('room', $roomType->id)}}">See more</a>
