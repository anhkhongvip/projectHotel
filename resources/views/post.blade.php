                ...
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="sidebar-box background-white drop-shadow rounded">
                        ...
                        <ul class="list-style circle-o pl-4 pb-0">
                            <li>
                                <a href="{{asset('post')}}" class="btn-link btn-primary pl-0">Don’t get lost.</a>
                            </li>
                            <li>
                                <a href="{{asset('post')}}" class="btn-link btn-primary pl-0">Moments from a life.</a>
                            </li>
                            <li>
                                <a href="{{asset('post')}}" class="btn-link btn-primary pl-0">Modern webdesign.</a>
                            </li>
                            <li>
                                <a href="{{asset('post')}}" class="btn-link btn-primary pl-0">Don´t give up...</a>
                            </li>
                        </ul>
                        <div class="separator-wrap my-5">
                            <span class="separator"><span class="separator-line dashed"></span></span>
