                ...
                <div class="col-md-6 col-xl-4 mb-4">
                    <div class="room-box background-white">
                        ...
                        <div class="room-box-in">
                            ...
                            <a class="mt-1 btn btn-primary" href="{{route('post', $blog->id)}}">read more</a>
...
{{--                            <a class="mt-1 btn btn-primary" href="{{asset('post')}}">read more</a>--}}
{{--                            <div class="room-icons news-tags mt-4 pt-4">--}}
{{--                                <a href="#">luxury</a>--}}
{{--                                <a href="#">vacation</a>--}}
{{--                                <a href="#">travel</a>--}}
...
{{--                </div>--}}
    ...
    <!-- Pagination -->
    <div class="shop_pagination_area wow fadeInUp d-flex justify-content-center mb-5" data-wow-delay="1.1s">
