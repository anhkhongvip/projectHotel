                    ...
                    <div class="col-md-10 col-lg-8">
                        ...
                        <form action="{{route('rooms.update', $room->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="dm-ecom-product-name" name="room-name" value="{{$room->name}}">
                            </div>

                            <div class="form-group">
                                <label for="dm-post-add-excerpt">Excerpt</label>
                                <textarea class="form-control" id="dm-post-add-excerpt" name="room_excerpt" rows="3" placeholder="Enter an excerpt..">{{$room->excerpt}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="js-ckeditor" name="room-description">{{$room->description}}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2 form-control" id="dm-ecom-product-category" name="room_type" style="width: 100%;" data-placeholder="Choose one..">
                                    ...
                                    @foreach($roomtype as $type)
                                        <option value="{{$type->id}}" {{$type->id == $room->rooms_type_id ? 'selected' : ''}}>{{$type->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="room_size" name="room_size" value="{{$room->room_size}}">
                            </div>

                            <div class="form-group">
                                <label for="dm-ecom-product-name">Occupancy</label>
                                <input type="text" class="form-control" id="room_occupancy" name="room_occupancy" value="{{$room->occupancy}}">
                            </div>

                            <div class="form-group">
                                <label for="dm-ecom-product-name">Bed Size</label>
                                <input type="text" class="form-control" id="room_bed_size" name="room_bed_size" value="{{$room->bed_size}}">
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="dm-ecom-image" name="images[]" value="{{$room->image}}" multiple>
                                </div>
                            </div>
