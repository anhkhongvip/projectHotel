                    ...
                    <div class="row justify-content-center push">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="dm-post-add-title" name="title" placeholder="Enter a title.." value="{{$post->title}}">
                            </div>
                            <div class="form-group">
                                <label for="dm-post-add-excerpt">Excerpt</label>
                                <textarea class="form-control" id="dm-post-add-excerpt" name="excerpt" rows="3" placeholder="Enter an excerpt..">{{$post->content}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <label>Body</label>
                                <textarea id="js-ckeditor" name="body">{{$post->post_detail}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center push">
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-fw fa-check mr-1"></i> Save Post
                            </button>
                        </div>
                    </div>
                </div>
