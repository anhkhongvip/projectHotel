        ...
        <div class="block-content">
            <div class="row items-push">
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-primary push" data-toggle="modal" data-target="#modal-block-tabs">Open Modal</button>
                    <!-- END Tabs in Modal -->
                </div>
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-primary push" data-toggle="modal" data-target="#modal-block-tabs-alternative">Open Modal</button>
